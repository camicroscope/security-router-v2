<?php
 ...
 $Url = "http://quip-data:9099/services/Camicroscope_DataLoader/DataLoader/query/getAll";
...
<html>
	...
	<body>
		<h1 id="heading">SEER VTR(CAMICROSCOPE QC)</h1>
		<div id="s_search">
...
var newData = [];
for(var i in data){
	data[i]['View Image'] =  "<a href='../camicroscope/osdCamicroscope.php?tissueId="+ data[i]['case_id']+"'>"+ data[i]['case_id'] + "</a>"
