...
list_user_cmd = "java -jar /var/www/html/camicSignup/trusted-app-client-0.0.1-jar-with-dependencies.jar -action l -id camicSignup secret " + trusted_secret + " -url http://" + bindaashost + "/trustedApplication"
